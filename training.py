...
from microchat.simple_tokenizer import SimpleTokenizer
...
if __name__ == "__main__":
    ...
    max_length = 4
    dataloader = SimpleDataLoader(raw_text, tokenizer, batch_size=8, max_length=max_length, stride=4, shuffle=False)
